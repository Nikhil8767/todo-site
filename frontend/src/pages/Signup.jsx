    ...
    return (<>
        ...
        <div className='flex justify-center items-center h-screen bg-gradient-to-r from-black to-gray-400'>
            ...
            <div className='space-y-5'>
                ...
                <button className='w-full bg-blue-500 rounded-lg text-white font-semibold py-2 hover:bg-blue-600' type='submit' onClick={handleSubmit} >Submit</button>
            </div>
            </div>
        </div>
        </>
